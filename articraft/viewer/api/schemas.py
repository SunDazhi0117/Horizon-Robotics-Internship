...
class ExportMp4Request(BaseModel):
    viewer_url: str | None = Field(default=None, min_length=1)
...
class ExportStagingMp4Response(ExportMp4Response):
    run_id: str


class GenerateFromPhotoImage(BaseModel):
    image_data: str = Field(min_length=1)
    image_filename: str | None = Field(default=None, max_length=255)
    image_content_type: str = Field(default="application/octet-stream", max_length=100)
...
class GenerateFromPhotoRequest(BaseModel):
    ...
    image_filename: str | None = Field(default=None, max_length=255)
    image_content_type: str = Field(default="application/octet-stream", max_length=100)
    images: list[GenerateFromPhotoImage] = Field(default_factory=list, max_length=8)


class GenerateFromPhotoResponse(BaseModel):
    status: str
    request_id: str
    prompt_path: str
    enhanced_prompt_path: str | None = None
    prompt_memory_path: str | None = None
    image_path: str
...
class FeedbackMemoryRequest(BaseModel):
    ...
    object_type: str = Field(default="", max_length=160)
    issue_types: list[str] = Field(default_factory=list, max_length=8)
    problem: str = Field(min_length=1, max_length=4000)
    fix: str = Field(default="", max_length=4000)
    tags: list[str] = Field(default_factory=list, max_length=16)


class FeedbackMemoryEntryResponse(BaseModel):
    feedback_id: str
    created_at: str
...
class FeedbackMemoryResponse(BaseModel):
    status: str
    feedback: FeedbackMemoryEntryResponse
