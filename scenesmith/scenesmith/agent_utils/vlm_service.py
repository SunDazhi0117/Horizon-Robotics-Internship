...
from scenesmith.agent_utils.codex_cli_model import codex_cli_completion
...
class VLMService:
    ...
    def __init__(self, service_tier: str | None = None) -> None:
        ...
        Args:
            service_tier: Optional service tier for API processing priority.
                ...
                project default.
        """
        self.provider = os.environ.get("SCENESMITH_VLM_PROVIDER", "openai")
    ...
    def create_completion(
        ...
        if self.provider == "codex-cli":
            return codex_cli_completion(
                messages,
                model=os.environ.get("SCENESMITH_CODEX_MODEL", "gpt-5.5"),
